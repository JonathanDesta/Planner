...
- `js/workout.js`: validates the version-1 Oly read-only feed. Current actual dates come from Oly. Future previews retain Monday/Tuesday/Thursday/Friday and the current dose until Oly advances the program.
